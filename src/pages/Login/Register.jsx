      ...
      const handleRegister = (e) => {
        ...
        createUser(email, password)
          .then((result) => {
            ...
            emailVerification()
              .then(() => {
                alert("successfully created account check you email and verify you account");
              })
              .then((error) => {
                console.error(error);
              });
    ...
    return (
      <div className="h-screen flex justify-center items-center">
        <div className="relative flex w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
          <div className="relative mx-4 -mt-6 mb-4 grid h-24 place-items-center overflow-hidden rounded-xl bg-gradient-to-tr from-pink-600 to-pink-400 bg-clip-border text-white shadow-lg shadow-pink-500/40">
